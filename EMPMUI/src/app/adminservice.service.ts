...
export class AdminserviceService {
  ...
  {
    const url = 'http://192.168.43.197:6500/employees_B';
    return this.con.post(url, obj);
  }

  singleSelect(id:String): Observable<any>
  {
    const url = 'http://192.168.43.197:6500/employees/{id}_A?id='+id;
    return this.con.get(url);
  }

  updateEmp(obj: Emp): Observable<any>
  {
    const url = 'http://192.168.43.197:6500/employees_C';
  ...
  {
    console.log(obj);
    const url = 'http://192.168.43.197:6500/client_B';
    return this.con.post(url, obj);
  }
  ...
  {
    console.log(obj);
    const url = 'http://192.168.43.197:6500/project_B';
    return this.con.post(url, obj);
  }
  ...
  allprojects(): Observable<any>
  {
    ...
    const url = 'http://192.168.43.197:6500/projectexpnddata';
    return this.con.get(url);
  }
